...
<?php
 ...
 require_once("./db/madre_load.php");
 loadPage();
 require_once("./db/loadtab_madref.php");
 tab_madref();
 if(isset($_POST["madre_alcol_alcol"])){
     $alcol = $_POST["madre_alcol_alcol"];
     $class1 = "";
 }
 else {
     $alcol = null;
 ...
 if(isset($_POST["madre_alcol_specA"])){
     $specA = $_POST["madre_alcol_specA"];
     $class2 = "";
 }
 else {
     $specA = null;
 ...
 if(isset($_POST["madre_alcol_stupefacenti"])){
     $stupefacenti = $_POST["madre_alcol_stupefacenti"];
     $class3 = "";
 }
 else {
     $stupefacenti = null;
 ...
 if(isset($_POST["madre_alcol_specS"])){
     $specS = $_POST["madre_alcol_specS"];
     $class4 = "";
 }
 else {
     $specS = null;
...
<br/<br/><br/>
<form id="adminform" name="adminform" action="db/madre_sendf.php" method="post">
        <div class="col-2">
        ...
        <div class="col-2">
            <label id="qualia" style="visibility:hidden;padding-top: 0px;" <?php echo "class=".$class2; ?>>
                Quali e quando *<br/>
                <?php
                    echo "<textarea name=\"qualiAlcool\" style=\"height:24px;\" $dis>".$specA."</textarea>";
                ?>
            </label>
        </div>
        <div class="col-2">
        ...
        <div class="col-2" >
            <label id="qualid" style="visibility:hidden;padding-top: 0px;" <?php echo "class=".$class4; ?>>
                Quali e quando *<br/>
                <?php
                    echo "<textarea name=\"qualiStupe\" style=\"height:24px;\" $dis>".$specS."</textarea>";
                ?>
            </label>
        </div>
