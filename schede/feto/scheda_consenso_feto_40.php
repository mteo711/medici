...
<br/<br/><br/>
<form enctype="multipart/form-data" action="db/consenso_sendf.php" method="POST">
    <div class="col-2">
    ...
    <div class="col-3">
        <label id="rDoc" style="visibility: hidden;padding-top: 6px;">
            <input name="riscontroDoc" <?php echo $dis; ?> type="file" accept=".png,.jpg,.jpeg,.pdf,.bmp" value="<?php echo $nome1; ?>">
        </label>
    </div>
    <!-- Analisi genetiche-->
    <div class="col-2">
    ...
    <div class="col-3">
        <label id="gDoc" style="visibility: hidden;padding-top: 6px;">
            <input name="geneticheDoc" <?php echo $dis; ?> type="file" accept=".png,.jpg,.jpeg,.pdf,.bmp">       
        </label>
    </div>
    ...
    <div class="col-3">
        <label id="tDoc" style="visibility: hidden;padding-top: 6px;">
            <input name="tossicologicheDoc" <?php echo $dis; ?> type="file" accept=".png,.jpg,.jpeg,.pdf,.bmp">       
        </label>
    </div>
    <div class="col-9">
