...
<?php
	...
	require_once("./db/prelievi_mf_load1.php");
	loadPage();
	require_once("./db/loadtab_prelievif.php");
	tab_prelievif();
	if(isset($_POST["prelievi_mf_corteccia"])&&($_POST["prelievi_mf_corteccia"]=='Y')){
		$checked1 = "checked";
	}
	else {
		$checked1 = "";
	}
	if(isset($_POST["prelievi_mf_ippocampo"])&&($_POST["prelievi_mf_ippocampo"]=='Y')){
		$checked2 = "checked";
	}
	else {
		$checked2 = "";
	}
	if(isset($_POST["prelievi_mf_nuclei"])&&($_POST["prelievi_mf_nuclei"]=='Y')){
		$checked3 = "checked";
	}
	else {
		$checked3 = "";
...
?>
<form id="adminform" name="adminform" action="db/prelievi_mf_send1.php" method="post">
	<div class="col-12">
		<label>
