...
<?php
	...
	require_once("./db/apparato_cardiovascolare_mf_load.php");
	loadPage();
...
<br/<br/><br/>
<form id="adminform" name="adminform" action="db/apparato_cardiovascolare_mf_send.php" method="post">	
	<div class="col-1">
	...
	<div class="col-3">
		<label style="padding-top: 8px;" >
			...
			<?php 
				echo "<input placeholder=\"mm\" id=\"diTr\" $dis name=\"diTr\" style=\"width: 100%;\" readonly value=\"".$diamT."\">";
			?>
		</label>
	</div>
	<div class="col-3">
		<label style="padding-top: 8px;" >
			...
			<?php
				echo "<input placeholder=\"mm\" id=\"diLo\" $dis name=\"diLo\" style=\"width: 100%;\" readonly value=\"".$diamL."\">";
			?>
		</label>
	</div>
	<div class="col-4">
		<label style="padding-top: 8px;" >
			...
			<?php
				echo "<input placeholder=\"mm\" id=\"diAP\" $dis name=\"diAP\" style=\"width: 100%;\" readonly value=\"".$diamAP."\">";
			?>
		</label>
	</div>
	<div class="col-4">
		<label style="padding-top: 36px;">
			...
			<?php
				echo "<input placeholder=\"mm\" id=\"spVD\" $dis name=\"spVD\" style=\"width: 100%;\" readonly value=\"".$spessVD."\">";
			?>
		</label>
	</div>
	<div class="col-4">
		<label style="padding-top: 36px;">
			...
			<?php
				echo "<input placeholder=\"mm\" id=\"spVS\" $dis name=\"spVS\" style=\"width: 100%;\" readonly value=\"".$spessVS."\">";
			?>
		</label>
	</div>
	<div class="col-4">
		<label style="padding-top: 8px;" <?php echo "class=".$class13; ?>>
			...
			<?php
				echo "<input placeholder=\"mm\" id=\"spSI\" $dis name=\"spSI\" style=\"width: 100%;\" readonly value=\"".$spessSI."\">";
			?>
		</label>
	</div>
	<div class="col-2">
	...
	<div class="col-2">
		<label style="padding-top: 8px;" <?php echo "class=".$class25; ?>>
			...
			<textarea name="vene" style="height:40px;" <?php echo $dis; ?>><?php echo $vene; ?></textarea>
		</label>
	</div>
	<div class="col-9">
