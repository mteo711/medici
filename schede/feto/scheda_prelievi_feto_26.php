...
<?php
	...
	require_once("./db/prelievi_mf_load4.php");
	loadPage();
	require_once("./db/loadtab_prelievif.php");
	tab_prelievif();
	if(isset($_POST["prelievi_mf_esofago"])&&($_POST["prelievi_mf_esofago"]=='Y')){
		$checked1 = "checked";
	}
	else {
		$checked1 = "";
	}
	if(isset($_POST["prelievi_mf_stomaco"])&&($_POST["prelievi_mf_stomaco"]=='Y')){
		$checked2 = "checked";
	}
	else {
		$checked2 = "";
	}
	if(isset($_POST["prelievi_mf_duodeno"])&&($_POST["prelievi_mf_duodeno"]=='Y')){
		$checked3 = "checked";
	}
	else {
		$checked3 = "";
	}
	if(isset($_POST["prelievi_mf_piccolo"])&&($_POST["prelievi_mf_piccolo"]=='Y')){
		$checked4 = "checked";
	}
	else {
		$checked4 = "";
	}
	if(isset($_POST["prelievi_mf_grosso"])&&($_POST["prelievi_mf_grosso"]=='Y')){
		$checked5 = "checked";
	}
	else {
		$checked5 = "";
...
?>
<form id="adminform" name="adminform" action="db/prelievi_mf_send4.php" method="post">
	<div class="col-12">
		<label>
