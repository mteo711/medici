...
require_once("./db/padre_noto_load.php");
loadPage();
require_once("./db/loadtab_padref.php");
tab_padref();
if(isset($_POST["padre_no"])){
    $noto = $_POST["padre_no"];
    $class1 = "";
}
else {
...
<script>
 $(function() {
    $( "#noto" ).selectmenu();
    $('#noto').val('<?php echo $noto; ?>');
    $('#noto').selectmenu('refresh', true);
});
...
<div id="dtBox"></div>
<br/<br/><br/>
<form id="adminform" name="adminform" action="db/padre_noto_sendf.php" method="post">
    <div id="error" class="col-1">
		<label style="font-size: 10px; color: #e80d0d;" align="justify" class="cart">
		 <img src="img/info.png" style="width: 30px; height: 30px; vertical-align:middle;" onclick="popupCenter('comuni/popup5.php', 'Avviso!',510,200);" href="javascript:void(0);"/>
		</label>
	</div>
    <div class="col-1">
        <label style="padding-top: 9px;" <?php echo "class=".$class1; ?>>
            Padre noto *<br/>
            <select tabindex="11" id="noto" name="noto" style="width:75%;" <?php echo $dis; ?>>
