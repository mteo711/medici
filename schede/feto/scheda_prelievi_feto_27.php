...
<?php
	...
	require_once("./db/prelievi_mf_load5.php");
	loadPage();
	require_once("./db/loadtab_prelievif.php");
	tab_prelievif();
	if(isset($_POST["prelievi_mf_sd"])&&($_POST["prelievi_mf_sd"]=='Y')){
		$checked1 = "checked";
	}
	else {
		$checked1 = "";
	}
	if(isset($_POST["prelievi_mf_ss"])&&($_POST["prelievi_mf_ss"]=='Y')){
		$checked2 = "checked";
	}
	else {
		$checked2 = "";
	}
	if(isset($_POST["prelievi_mf_rd"])&&($_POST["prelievi_mf_rd"]=='Y')){
		$checked3 = "checked";
	}
	else {
		$checked3 = "";
	}
	if(isset($_POST["prelievi_mf_rs"])&&($_POST["prelievi_mf_rs"]=='Y')){
		$checked4 = "checked";
	}
	else {
		$checked4 = "";
...
?>
<form id="adminform" name="adminform" action="db/prelievi_mf_send5.php" method="post">
	<div class="col-1">
