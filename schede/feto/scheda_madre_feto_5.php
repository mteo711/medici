...
<?php
 ...
 require_once("./db/madre_load2.php");
 loadPage();
 require_once("./db/loadtab_madref.php");
 tab_madref();
 if(isset($_POST["madre_farmaci_farmaci"])){
     $farmaci = $_POST["madre_farmaci_farmaci"];
     $class1 = "";
 }
 else {
     $farmaci = null;
 ...
 if(isset($_POST["madre_farmaci_specF"])){
     $specF = $_POST["madre_farmaci_specF"];
     $class2 = "";
 }
 else {
     $specF = null;
 ...
 if(isset($_POST["madre_farmaci_HIV"])){
     $hiv = $_POST["madre_farmaci_HIV"];
     $class3 = "";
 }
 else {
     $hiv = null;
...
<form id="adminform" name="adminform" action="db/madre_sendf.php" method="post">    
    ...
    <div class="col-2">
        <label id="qualif" style="visibility:hidden;padding-top: 0px;" <?php echo "class=".$class2; ?>>
            Quali *<br/>
            <?php
                echo "<textarea name=\"quali\" style=\"height:24px;\" $dis>".$specF."</textarea>";
            ?>
        </label>
    </div>
    <div class="col-2">
        <label style="padding-top: 7px;" <?php echo "class=".$class3; ?>>
            È risultata positiva al virus dell'HIV? *<br/>
