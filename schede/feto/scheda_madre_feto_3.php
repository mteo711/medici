...
<br/<br/><br/>
<form id="adminform" name="adminform" action="db/fumo_attivo_sendf.php" method="post">
    <div class="col-3">
        <label style="padding-top: 12px;" <?php echo "class=".$class1; ?>>
    ...
    <div class="col-3">
        <label id="prima" style="visibility: hidden;padding-top: 10px;" <?php echo "class=".$class2; ?>>
            Dall'età di *<br/>
            <?php
    ...
    <div class="col-3">
        <label id="prima2" style="visibility: hidden;padding-top: 10px;" <?php echo "class=".$class3; ?>>
    ...
    <div class="col-3">
        <label style="padding-top: 12px;" <?php echo "class=".$class4; ?>>
    ...
    <div class="col-3">
        <label id="durante" style="visibility: hidden;padding-top: 10px;" <?php echo "class=".$class5; ?>>
    ...
    <div class="col-3">
        <label id="durante2" style="visibility: hidden;padding-top: 10px;" <?php echo "class=".$class6; ?>>
            Numero sigarette/giorno *<br/>
            <?php
    ...
    <div class="col-3">
        <label style="padding-top: 12px;" <?php echo "class=".$class7; ?>>
            Dopo il parto *<br/>
    ...
    <div class="col-3">
        <label id="dopo" style="visibility: hidden;padding-top: 10px;" <?php echo "class=".$class8; ?>>
    ...
    <div class="col-3">
        <label id="dopo2" style="visibility: hidden;padding-top: 10px;" <?php echo "class=".$class9; ?>>
            Numero sigarette/giorno *<br/>
            <?php
