...
$( document ).ready(function() {
    if ('<?php echo $prima; ?>' == 'Y'){
       document.getElementById('pprima').style.visibility='visible';           document.getElementById('pprima2').style.visibility='visible';
    }
    if ('<?php echo $durante; ?>' == 'Y'){
       document.getElementById('pdurante').style.visibility='visible';                    document.getElementById('pdurante2').style.visibility='visible';
    }
    if ('<?php echo $dopo; ?>' == 'Y'){
           document.getElementById('pdopo').style.visibility='visible';                    document.getElementById('pdopo2').style.visibility='visible';
    }
  });
...
<br/<br/><br/>
<form id="adminform" name="adminform" action="db/fumo_passivo_send.php" method="post">
    <div class="col-3">
    ...
    <div class="col-3">
        <label id="pprima" style="visibility: hidden;padding-top: 7px;" <?php echo "class=".$class2; ?>>
            Dall'età di *<br/>
            <?php
             echo "<input id=\"etaSigPass1\" $dis name=\"etaSigPass1\" style=\"width: 100%;\" readonly value=\"".$primaA."\">";
            ?>
        </label>
    </div>
    <div class="col-3">
    ...
    <div class="col-3">
        <label id="pdurante" style="visibility: hidden; padding-top: 7px;" <?php echo "class=".$class5; ?>>
            ...
            <?php
             echo "<input id=\"etaSigPass2\" $dis name=\"etaSigPass2\" style=\"width: 100%;\" readonly value=\"".$duranteA."\">";
            ?>
        </label>
    </div>
    <div class="col-3">
    ...
    <div class="col-3">
        <label id="pdopo" style="visibility: hidden; padding-top: 7px;" <?php echo "class=".$class8; ?>>
            ...
            <?php
             echo "<input id=\"etaSigPass3\" $dis name=\"etaSigPass3\" style=\"width: 100%;\" readonly value=\"".$dopoA."\">";
            ?>
        </label>
    </div>
    <div class="col-3">
