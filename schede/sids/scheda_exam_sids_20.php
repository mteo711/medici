...
<?php
	...
	require_once("./db/apparato_respiratorio_sids_load.php");
	loadPage();
...
<form id="adminform" name="adminform" action="db/apparato_respiratorio_sids_send.php" method="post">
	<div class="col-3">
	...
	<div class="col-4">
		<label style="padding-top: 8px;" <?php echo "class=".$class4; ?>>
			...
			<?php
				echo "<input placeholder=\"gr.\" $dis id=\"polSX\" name=\"polSX\" style=\"width: 100%;\" readonly value=\"".$pesoSX."\">";
			?>
		</label>
	</div>
	<div class="col-4">
		<label style="padding-top: 8px;" <?php echo "class=".$class5; ?>>
			...
			<?php
				echo "<input placeholder=\"gr.\" $dis id=\"polDX\" name=\"polDX\" style=\"width: 100%;\" readonly value=\"".$pesoDX."\">";
			?>
		</label>
	</div>
	<div class="col-4">
		<label style="padding-top: 8px;" <?php echo "class=".$class6; ?>>
			Numero lobi SX *<br/>
			<?php
				echo "<input id=\"lobSX\" $dis name=\"lobSX\" style=\"width: 100%;\" readonly value=\"".$lobiSX."\">";
			?>
		</label>
	</div>
	<div class="col-4">
		<label style="padding-top: 8px;" <?php echo "class=".$class7; ?>>
			Numero lobi DX *<br/>
			<?php
				echo "<input id=\"lobDX\" $dis name=\"lobDX\" style=\"width: 100%;\" readonly value=\"".$lobiDX."\">";
			?>			
		</label>
	</div>
	<div class="col-3">
