...
<?php
	...
	require_once("./db/prelievi_sids_load2.php");
	loadPage();
	require_once("./db/loadtab_prelievi.php");
	tab_prelievi();
	if(isset($_POST["prelievi_sids_dxilo"])&&($_POST["prelievi_sids_dxilo"]=='Y')){
		$checked1 = "checked";
	}
	else {
		$checked1 = "";
	}
	if(isset($_POST["prelievi_sids_sxilo"])&&($_POST["prelievi_sids_sxilo"]=='Y')){
		$checked2 = "checked";
	}
	else {
		$checked2 = "";
	}
	if(isset($_POST["prelievi_sids_dxsup"])&&($_POST["prelievi_sids_dxsup"]=='Y')){
		$checked3 = "checked";
	}
	else {
		$checked3 = "";
	}
	if(isset($_POST["prelievi_sids_sxsup"])&&($_POST["prelievi_sids_sxsup"]=='Y')){
		$checked4 = "checked";
	}
	else {
		$checked4 = "";
	}
	if(isset($_POST["prelievi_sids_dxmedio"])&&($_POST["prelievi_sids_dxmedio"]=='Y')){
		$checked5 = "checked";
	}
	else {
		$checked5 = "";
	}
	if(isset($_POST["prelievi_sids_sxinf"])&&($_POST["prelievi_sids_sxinf"]=='Y')){
		$checked6 = "checked";
	}
	else {
		$checked6 = "";
	}
	if(isset($_POST["prelievi_sids_dxinf"])&&($_POST["prelievi_sids_dxinf"]=='Y')){
		$checked7 = "checked";
	}
	else {
		$checked7 = "";
...
?>
<form id="adminform" name="adminform" action="db/prelievi_sids_send2.php" method="post">
	<div class="col-1">
