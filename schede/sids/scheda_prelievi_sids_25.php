...
<?php
   if (($_SESSION["stato"] == 'chiusa') || ($_SESSION["stato"] == 'chiusa_usr')){
	...
	require_once("./db/prelievi_sids_load3.php");
	loadPage();
	require_once("./db/loadtab_prelievi.php");
	tab_prelievi();
	if(isset($_POST["prelievi_sids_paragangli"])&&($_POST["prelievi_sids_paragangli"]=='Y')){
		$checked1 = "checked";
	}
	else {
		$checked1 = "";
	}
	if(isset($_POST["prelievi_sids_aorta"])&&($_POST["prelievi_sids_aorta"]=='Y')){
		$checked2 = "checked";
	}
	else {
		$checked2 = "";
	...
	if(isset($_POST["prelievi_sids_pericardio"])&&($_POST["prelievi_sids_pericardio"]=='Y')){
		$checked4 = "checked";
	}
	else {
		$checked4 = "";
	}
	if(isset($_POST["prelievi_sids_atrioDX"])&&($_POST["prelievi_sids_atrioDX"]=='Y')){
		$checked5 = "checked";
	}
	else {
		$checked5 = "";
	}
	if(isset($_POST["prelievi_sids_atrioSX"])&&($_POST["prelievi_sids_atrioSX"]=='Y')){
		$checked6 = "checked";
	}
	else {
		$checked6 = "";
	}
	if(isset($_POST["prelievi_sids_setto"])&&($_POST["prelievi_sids_setto"]=='Y')){
		$checked7 = "checked";
	}
	else {
		$checked7 = "";
	}
	if(isset($_POST["prelievi_sids_ventrDX"])&&($_POST["prelievi_sids_ventrDX"]=='Y')){
		$checked8 = "checked";
	}
	else {
		$checked8 = "";
	}
	if(isset($_POST["prelievi_sids_ventrSX"])&&($_POST["prelievi_sids_ventrSX"]=='Y')){
		$checked9 = "checked";
	}
	else {
		$checked9 = "";
	}
	if(isset($_POST["prelievi_sids_ramoA"])&&($_POST["prelievi_sids_ramoA"]=='Y')){
		$checked10 = "checked";
	}
	else {
		$checked10 = "";
	}
	if(isset($_POST["prelievi_sids_ramoC"])&&($_POST["prelievi_sids_ramoC"]=='Y')){
		$checked11 = "checked";
	}
	else {
		$checked11 = "";
	}
	if(isset($_POST["prelievi_sids_ramoP"])&&($_POST["prelievi_sids_ramoP"]=='Y')){
		$checked12 = "checked";
	}
	else {
		$checked12 = "";
	}
	if(isset($_POST["prelievi_sids_ramoM"])&&($_POST["prelievi_sids_ramoM"]=='Y')){
		$checked13 = "checked";
	}
	else {
		$checked13 = "";
...
?>
<form id="adminform" name="adminform" action="db/prelievi_sids_send3.php" method="post">
	<div class="col-12">
		<label>
