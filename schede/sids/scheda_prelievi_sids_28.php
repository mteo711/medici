...
<?php
	...
	require_once("./db/prelievi_sids_load6.php");
	loadPage();
	require_once("./db/loadtab_prelievi.php");
	tab_prelievi();
	if(isset($_POST["prelievi_sids_stellato"])&&($_POST["prelievi_sids_stellato"]=='Y')){
		$checked1 = "checked";
	}
	else {
		$checked1 = "";
	}
	if(isset($_POST["prelievi_sids_cervicale"])&&($_POST["prelievi_sids_cervicale"]=='Y')){
		$checked2 = "checked";
	}
	else {
		$checked2 = "";
	}
	if(isset($_POST["prelievi_sids_corpo"])&&($_POST["prelievi_sids_corpo"]=='Y')){
		$checked3 = "checked";
	}
	else {
		$checked3 = "";
	}
	if(isset($_POST["prelievi_sids_seno"])&&($_POST["prelievi_sids_seno"]=='Y')){
		$checked4 = "checked";
	}
	else {
		$checked4 = "";
	}
	if(isset($_POST["prelievi_sids_timo"])&&($_POST["prelievi_sids_timo"]=='Y')){
		$checked5 = "checked";
	}
	else {
		$checked5 = "";
	}
	if(isset($_POST["prelievi_sids_tiroide"])&&($_POST["prelievi_sids_tiroide"]=='Y')){
		$checked6 = "checked";
	}
	else {
		$checked6 = "";
	}
	if(isset($_POST["prelievi_sids_milza"])&&($_POST["prelievi_sids_milza"]=='Y')){
		$checked7 = "checked";
	}
	else {
		$checked7 = "";
	}
	if(isset($_POST["prelievi_sids_fegato"])&&($_POST["prelievi_sids_fegato"]=='Y')){
		$checked8 = "checked";
	}
	else {
		$checked8 = "";
	}
	if(isset($_POST["prelievi_sids_pancreas"])&&($_POST["prelievi_sids_pancreas"]=='Y')){
		$checked9 = "checked";
	}
	else {
		$checked9 = "";
...
?>
<form id="adminform" name="adminform" action="db/prelievi_sids_send6.php" method="post">
