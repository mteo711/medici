...
CREATE  TABLE IF NOT EXISTS `sids_mf_db`.`apparato_respiratorio_mf` (
  ...
  CONSTRAINT `fk_apparato_respiratorio_mf_dati_protocollo_mf`
...
class apparato_respiratorio_mf extends Database
{   
