<?php
    ...
    function tab_lattante() {
        ...
        if($records['idmedici'] == null){
            ...
            if (($records['data_ultimo_controllo_pediatrico']==null) || ($records['patologie_in_atto']==null) || ( ($records['patologie_in_atto'] == 'Y') && ($records['tipologie_patologie_in_atto']==null) && ($records['specifica_tipologie_patologie_in_atto']==null)) || ($records['disturbi_respiratori']==null) || (($records['disturbi_respiratori']=='Y') && (($records['tipologie_disturbi_respiratori']==null) && ($records['specifica_tipologie_disturbi_respiratori']==null))) || (($records['vaccinazioni_ultimo_mese']==null) || (($records['vaccinazioni_ultimo_mese']=='Y') && ($records['tipologie_vaccinazioni_ultimo_mese']==null))) || (($records['effettuato_riscontro_diagnostico']==null) || (($records['effettuato_riscontro_diagnostico']=='Y') && ($records['riscontro_diagnostico_dove']==null))) || (($records['prelievi_secondo_prot_naz']==null) || (($records['prelievi_secondo_prot_naz']=='Y') && (($records['data_riscontro_diagnostico']==null) || ($records['medico_effettuato_riscontro']==null))))){
