...
CREATE  TABLE IF NOT EXISTS `sids_mf_db`.`apparato_cardiovascolare_sids` (
  ...
  CONSTRAINT `fk_apparato_cardiovascolare_sids_dati_protocollo_sids`
...
class apparato_cardiovascolare_sids extends Database
{   
