...
CREATE  TABLE IF NOT EXISTS `sids_mf_db`.`cavo_orale_sids` (
  `dati_protocollo_sids_schede_id` INT UNSIGNED NOT NULL ,
  `tiroide_peso_gr` DECIMAL(6,2) NULL ,
  `paratiroidi` TINYTEXT NULL ,
  `timo_peso_gr` DECIMAL(6,2) NULL ,
  `linfonodi` TINYTEXT NULL ,
  `blocco_lingua_ipofaringe` TINYTEXT NULL ,
  `ghiandole_salivari_paralinguali` VARCHAR(45) NULL ,
  PRIMARY KEY (`dati_protocollo_sids_schede_id`) ,
  CONSTRAINT `fk_cavo_orale_sids_dati_protocollo_sids`
...
class cavo_orale_sids extends Database
{   
 ...
 private  $columns = array('dati_protocollo_sids_schede_id' => 'int',
				...
				'timo'  => 'string',
				'linfonodi'  => 'string',
				'blocco_lingua_ipofaringe'  => 'string',				
				'ghiandole_salivari_paralinguali'  => 'string',
                'conclusa' => 'bool'
				);
