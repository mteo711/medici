...
CREATE TABLE `dati_feto` (
  ...
  `morte_come` VARCHAR(100) DEFAULT NULL,
  `morte_dove` VARCHAR(100) DEFAULT NULL,
  `morte_quando` DATE DEFAULT NULL,
  `conclusa` enum('Y','N') DEFAULT NULL,
...
CREATE TABLE `dati_pers` (
  ...
  `rischi` text DEFAULT NULL,
  `titolo_studio` varchar(16) DEFAULT NULL,
  `stato_civile` enum('mancante','nubile','separato', 'divorziato', 'vedovo', 'coniugato','convivente','separata', 'divorziata', 'vedova', 'madre single', 'coniugata') DEFAULT NULL,
  `specifica_matrimonio` date DEFAULT NULL,
  `altezza` varchar(30) DEFAULT NULL,
  `peso` varchar(30) DEFAULT NULL,
  `morte_feto` tinytext DEFAULT NULL,
  `ultimo_avvistamento` tinytext DEFAULT NULL,
  `fecondazione` varchar(50) DEFAULT NULL,
  `dataF` date DEFAULT NULL,
  `struttura` varchar(50) DEFAULT NULL,
  `inseminazione_endouterina` enum('Y','N') DEFAULT NULL,
  `fecondazione_in_vitro` enum('Y','N') DEFAULT NULL,
  `intracitoplasmatica` enum('Y','N') DEFAULT NULL,
  `gameti` enum('Y','N') DEFAULT NULL,
  `ovulazione_indotta` enum('Y','N') DEFAULT NULL,
  `omologa` enum('Y','N') DEFAULT NULL,
  `eterologa` varchar(50) DEFAULT NULL,
  `embriodonazione` enum('Y','N') DEFAULT NULL,
  `a_fresco` enum('Y','N') DEFAULT NULL,
  `crioconservazione` enum('Y','N') DEFAULT NULL,
  `test_preimpianto` enum('Y','N') DEFAULT NULL,
  `specifica_altre` varchar(50) DEFAULT NULL,
  `num_visite` int unsigned DEFAULT NULL,
  `anni_nonnamaterna` int DEFAULT NULL,
  `anni_nonnomaterno` int DEFAULT NULL,
  `patologie_nonnamaterna` varchar(255) DEFAULT NULL,
  `patologie_nonnomaterno` varchar(255) DEFAULT NULL,
  `fratelli_sorelle` varchar(255) DEFAULT NULL,
  `patologie_famiglia` varchar(255) DEFAULT NULL,
  `altricasi` varchar(255) DEFAULT NULL,
  `altri_casi` varchar(255) DEFAULT NULL,
  `nonnaviva` varchar(255) DEFAULT NULL,
  `nonnovivo` varchar(255) DEFAULT NULL,
  `morte_nonnamaterna` varchar(255) DEFAULT NULL,
  `morte_nonnomaterno` varchar(255) DEFAULT NULL,
  `conclusa` enum('Y','N') DEFAULT NULL,
...
CREATE TABLE `info_morte_fetale` (
  ...
  `ultima_visita_ostetrica` date DEFAULT NULL,
  `ginecologo_curante` varchar(50) DEFAULT NULL,
  `ostetrica` varchar(50) DEFAULT NULL,
  `fecondazione` varchar(50) DEFAULT NULL,
  `dataF` date DEFAULT NULL,
  `struttura` varchar(50) DEFAULT NULL,
  `inseminazione_endouterina` enum('Y','N') DEFAULT NULL,
...
CREATE TABLE `patologie_gest` (
  ...
  `tipologie_infezioni_materne_preconcezionale` set('hiv','hbv','hcv','lue','toxo','cmv','rubeo','hmv','altro') DEFAULT NULL,
  `specifica_tipologie_infezioni_materne_preconcezionale` tinytext,
  `tipologie_infezioni_materne_peri_postconcezionale` set('hiv','hbv','hcv','lue','toxo','cmv','rubeo','hmv','altro') DEFAULT NULL,
  ...
  `screening` enum('Y','N','mancante') DEFAULT NULL,
  `tipo_screening` set('NT_Patologico','NT_nonPatologico','cromosopatie_Patologico','cromosopatie_nonPatologico','triplotest_Patologico','riplotest_nonPatologico') DEFAULT NULL,
  `sangue_materno` enum('Y','N','mancante') DEFAULT NULL,
  `dataDNA` date DEFAULT NULL,
  `risultato` varchar(50) DEFAULT NULL,
  `altri_test` varchar(50) DEFAULT NULL,
