...
if(isset($_SESSION["frat_mF"])){
  ...
  $fratf = 'tabs';
	...
	if ($tab == 1){
echo <<<STAMP
	<button class="tabs_att" id="t1" onclick="location.href='scheda_reg.php?scheda=madre&tab=1&tipo=feto'" $p1>Dati Personali</button>
	<button class="$partmf" id="t2" onclick="location.href='scheda_reg.php?scheda=madre&tab=2&tipo=feto'" $p2>Aborti Precedenti</button>
    <button class="$fratf" id="t1" onclick="location.href='scheda_reg.php?scheda=madre&tab=8&tipo=feto'" $p9>Altri Figli</button>
<button class="$fattf" id="t3" onclick="location.href='scheda_reg.php?scheda=madre&tab=3&tipo=feto'" $p3>Fumo Attivo</button>
<button class="$fpassf" id="t30" onclick="location.href='scheda_reg.php?scheda=madre&tab=30&tipo=feto'" $p4>Fumo Passivo</button>
...
STAMP;
	...
	if ($tab == 2){
	echo <<<STAMP
	<button class="$persmf" id="t1" onclick="location.href='scheda_reg.php?scheda=madre&tab=1&tipo=feto'" $p1>Dati Personali</button>
	<button class="tabs_att" id="t2" onclick="location.href='scheda_reg.php?scheda=madre&tab=2&tipo=feto'" $p2>Aborti Precedenti</button>
    <button class="$fratf" id="t1" onclick="location.href='scheda_reg.php?scheda=madre&tab=8&tipo=feto'" $p9>Altri Figli</button>
	<button class="$fattf" id="t3" onclick="location.href='scheda_reg.php?scheda=madre&tab=3&tipo=feto'" $p3>Fumo Attivo</button>
	<button class="$fpassf" id="t30" onclick="location.href='scheda_reg.php?scheda=madre&tab=30&tipo=feto'" $p4>Fumo Passivo</button>
	<button class="$alcmf" id="t4" onclick="location.href='scheda_reg.php?scheda=madre&tab=4&tipo=feto'" $p5>Alcol/Stupefacenti</button>
...
echo <<<STAMP
	...
	<button class="$partmf" id="t2" onclick="location.href='scheda_reg.php?scheda=madre&tab=2&tipo=feto'" $p2>Aborti Precedenti</button>
    <button class="$fratf" id="t1" onclick="location.href='scheda_reg.php?scheda=madre&tab=8&tipo=feto'" $p9>Altri Figli</button>
	<button class="tabs_att" id="t3" onclick="location.href='scheda_reg.php?scheda=madre&tab=3&tipo=feto'" $p3>Fumo Attivo</button>
	<button class="$fpassf" id="t30" onclick="location.href='scheda_reg.php?scheda=madre&tab=30&tipo=feto'" $p4>Fumo Passivo</button>
	<button class="$alcmf" id="t4" onclick="location.href='scheda_reg.php?scheda=madre&tab=4&tipo=feto'" $p5>Alcol/Stupefacenti</button>
	<button class="$farmmf" id="t5" onclick="location.href='scheda_reg.php?scheda=madre&tab=5&tipo=feto'" $p6>Farmaci</button>
	<button class="$patomf" id="t6" onclick="location.href='scheda_reg.php?scheda=madre&tab=6&tipo=feto'" $p7>Patologie gestante</button>
...
echo <<<STAMP
    ...
    <button class="$fratf" id="t1" onclick="location.href='scheda_reg.php?scheda=madre&tab=8&tipo=feto'" $p9>Altri Figli</button>
	<button class="$fattf" id="t3" onclick="location.href='scheda_reg.php?scheda=madre&tab=3&tipo=feto'" $p3>Fumo Attivo</button>
	<button class="tabs_att" id="t30" onclick="location.href='scheda_reg.php?scheda=madre&tab=30&tipo=feto'" $p4>Fumo Passivo</button>
	<button class="$alcmf" id="t4" onclick="location.href='scheda_reg.php?scheda=madre&tab=4&tipo=feto'" $p5>Alcol/Stupefacenti</button>
	<button class="$farmmf" id="t5" onclick="location.href='scheda_reg.php?scheda=madre&tab=5&tipo=feto'" $p6>Farmaci</button>
	<button class="$patomf" id="t6" onclick="location.href='scheda_reg.php?scheda=madre&tab=6&tipo=feto'" $p7>Patologie gestante</button>
	<button class="$mestruof" id="t5" onclick="location.href='scheda_reg.php?scheda=madre&tab=7&tipo=feto'" $p8>Mestruazioni</button>
...
echo <<<STAMP
	<button class="$persmf" id="t1" onclick="location.href='scheda_reg.php?scheda=madre&tab=1&tipo=feto'" $p1>Dati Personali</button>
	<button class="$partmf" id="t2" onclick="location.href='scheda_reg.php?scheda=madre&tab=2&tipo=feto'" $p2>Aborti Precedenti</button>
    <button class="tabs_att" id="t1" onclick="location.href='scheda_reg.php?scheda=madre&tab=8&tipo=feto'" $p9>Altri Figli</button>
	<button class="$fattf" id="t3" onclick="location.href='scheda_reg.php?scheda=madre&tab=3&tipo=feto'" $p3>Fumo Attivo</button>
	<button class="$fpassf" id="t30" onclick="location.href='scheda_reg.php?scheda=madre&tab=30&tipo=feto'" $p4>Fumo Passivo</button>
	<button class="$alcmf" id="t4" onclick="location.href='scheda_reg.php?scheda=madre&tab=4&tipo=feto'" $p5>Alcol/Stupefacenti</button>
	<button class="$farmmf" id="t5" onclick="location.href='scheda_reg.php?scheda=madre&tab=5&tipo=feto'" $p6>Farmaci</button>
